...
func init() {
	...
	apiKey := os.Getenv("UNIDOC_API_KEY")
	if apiKey == "" {
		fmt.Printf("ERROR: UNIDOC_API_KEY environment variable not set\n")
		fmt.Printf("Make sure to get a valid key from https://cloud.unidoc.io\n")
		panic("UNIDOC_API_KEY environment variable not set")
	}

	// Set the metered license key
